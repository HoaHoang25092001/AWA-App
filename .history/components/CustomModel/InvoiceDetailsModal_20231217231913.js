...
const InvoiceDetailsModal = ({ visible, onClose, setStatusTT }) => {
  const { invoice, statusIF, invoiceChuaTTByMaKH } = useSelector((state) => state.invoice);
      ...
      .join("")}
        ...
        invoice.tongTienTruocVat
            ...
            <tr class="tabletitle">
              ...
              <td></td>
              <td class="itemTax"><h4>${invoice.phiVAT}</h4></td>
            </tr>
                      ...
                      <IntlProvider locale="vi-VN">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              {invoice.chiSoDongHo.thangTaoSoDoc}
                            </Text>
                          </View>
                          <View
                            style={{
                        ...
                        {invoiceChuaTTByMaKH.trangThaiThanhToan !== invoice.trangThaiThanhToan ? (
