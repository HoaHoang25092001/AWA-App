...
const SamplePrint = ({ data }) => {
    ...
    <div id="invoice-POS">
      ...
      <div id="bot">
        <div id="table">
          <table>
            <tr class="tabletitle">
              <td class="itemTable"><h5>Số lượng</h5></td>
              <td class="itemTable"><h5>Đơn giá</h5></td>
              <td class="itemTable"><h5>Thành tiền</h5></td>
            </tr>
            ...
            <tr class="tabletitle">
              ...
              <td></td>
              <td class="itemTotal"><h2>${formatCurrencyVND(data.tongTienTruocVat)}</h2></td>
            </tr>
            ...
            <tr class="tabletitle">
              ...
              <td></td>
              <td class="itemTotal"><h2>${formatCurrencyVND(data.tongTienHoaDon)}</h2></td>
            </tr>
          </table>
  ...
  return (
    <>
      <Button title="Chụp và in hóa đơn" onPress={printBill} />
      <ScrollView>
