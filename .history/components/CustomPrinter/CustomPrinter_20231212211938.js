    ...
    <IntlProvider locale="vi-VN">
      <ScrollView style={styles.container}>
        <View style={styles.bluetoothStatusContainer}>
          <TouchableOpacity
            onPress={() => navigator.navigate('Danh sách hóa đơn', { paymentRecordID: invoiceID })}
             style={{
              alignItems: 'center',
              paddingLeft: 20
            }}>
        ...
        <Text style={styles.sectionTitle}>
          Máy in đã được kết nối tới ứng dụng:
        </Text>
        ...
        <Text style={styles.sectionTitle}>
          Bluetooth đã được kết nối đến điện thoại này:
        </Text>
        ...
        <View style={{ height: 100 }}>
          <Button onPress={() => scanBluetoothDevice()} title="Quét Bluetooth" />
        </View>
      </ScrollView>
    </IntlProvider>
  );
