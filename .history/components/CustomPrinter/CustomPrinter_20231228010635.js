...
const CustomPrinter = ({ route, navigation, setStatusTT }) => {
        ...
        <IntlProvider locale="vi-VN">
            <ScrollView style={styles.container}>
                <View style={{
                    ...
                    <TouchableOpacity
                        onPress={() => navigator.navigate('DebtInvoice', { itemId: itemId, trangThaiGhi: trangThaiGhi, maKhachHang: maKhachHang })}>
                ...
                <SamplePrint data={invoice} setStatusTT={setStatusTT} />
