...
const CustomPrinterUnpaidInvoiceByMDL = ({ navigation, route }) => {
    const { paymentRecordID } = route.params;
    const navigator = useNavigation();
    const { invoice } = useSelector((state) => state.invoice);
    const { dataIdTheDienLuc, loadingIdTheDienLuc } = useSelector(
        ...
        <IntlProvider locale="vi-VN">
            <ScrollView style={styles.container}>
                <View style={{
                    ...
                    <TouchableOpacity
                        onPress={() => navigation.navigate('Danh sách hóa đơn', {paymentRecordID: paymentRecordID, statusPrint: statusPrint})}>
                ...
                <SamplePrint data={dataIdTheDienLuc} setStatusTT={setStatusTT} statusTT={statusTT} setStatusPrint={setStatusPrint} statusPrint={statusPrint}/>
...
export default CustomPrinterUnpaidInvoiceByMDL;
