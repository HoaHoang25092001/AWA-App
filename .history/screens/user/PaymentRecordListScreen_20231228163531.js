        ...
        >
            <SafeAreaView>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    />
                    {/* Models */}
                    <InvoiceDetailsModal id={paymentRecordID} visible={showInvoiceDetailsModal} onClose={() => setShowInvoiceDetailsModal(false)} setStatusTT={setStatusTT} paymentRecordID={paymentRecordID}/>
                </ScrollView>
            </SafeAreaView>
            {/*---------------Search Modal--------------------*/}
            <Modal
