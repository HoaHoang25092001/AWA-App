...
function PaymentRecordScreen({ navigation }) {
    ...
    // };
    const PaymentRecordCard = ({ item }) => (
        <TouchableOpacity
            onPress={() => navigator.navigate('Danh sách hóa đơn', { paymentRecordID: item.id })}
        >
            <Box
                style={{
                    borderRadius: 9,
                    ...
                    <VStack>
                        ...
                        >
                            <View style={{
                                ...
                                <Text style={styles.titleItem}>{item.tenSo}</Text>
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                                ...
                                }}>{item.soLuongHoaDonDaTT}/{item.tongSoLuongHoaDon} (khách)</Text>
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                alignItems: 'center',
                                ...
                                <Text style={{
                                    ...
                                    {formatCurrencyVND(item.tongSoTienDaThu)}
                                    /{formatCurrencyVND(item.tongSoTienHoaDon)} (VNĐ)
                                </Text>
                            </View>
                            <View style={{
                                flexDirection: 'row',
                                ...
                                <Text style={{
                                    ...
                                    color: '#5a6a85',
                                    fontFamily: "Quicksand_700Bold",
                                }}>{moment(item?.createdTime, 'MM/DD/YYYY').format('DD/MM/YYYY')}</Text>
                            </View>
                        </View>
                        <View style={{
                            marginTop: 5
    ...
    return (
        <SafeAreaView style={{ marginBottom: "35%" }}>
            ...
            <Pagination
                ...
                pageSize={10}
                currentPage={soThanhToanTheoSoDoc.pageNumber}
