...
function PaymentRecordScreen({ navigation }) {
    ...
    const searchSoThanhToan = async () => {
        ...
        try {
            ...
            console.log("Invoice", response.items);
                            ...
                            <Box w="90%" maxW="400">
                                <VStack space="md">
                                    ...
                                    <Box maxW="100%" alignItems="center">
                                        <Input variant="outline" size="md" onChangeText={handleChange} focusOutlineColor={"blue.200"} value={tenSoDoc} placeholder="Nhập tên sổ" />
                                    </Box>
