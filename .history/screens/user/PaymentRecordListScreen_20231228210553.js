        ...
        >
            <SafeAreaView>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    />
                    {/* Models */}
                    <InvoiceDetailsModal id={paymentRecordID} visible={showInvoiceDetailsModal} onClose={() => setShowInvoiceDetailsModal(false)} setStatusTT={setStatusTT} paymentRecordID={paymentRecordID} statusTT={statusTT}/>
                </ScrollView>
            </SafeAreaView>
            {/*---------------Search Modal--------------------*/}
            <Modal
