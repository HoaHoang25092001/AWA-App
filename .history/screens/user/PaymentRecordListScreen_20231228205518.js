...
function PaymentRecordListScreen({ route, navigation }) {
    ...
    }, [navigation, paymentRecordID, currentPage, service, dispatch, statusTT, statusPrint])
        ...
        >
            <SafeAreaView>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    />
                    {/* Models */}
                    <InvoiceDetailsModal id={paymentRecordID} visible={showInvoiceDetailsModal} onClose={() => setShowInvoiceDetailsModal(false)} setStatusTT={setStatusTT} paymentRecordID={paymentRecordID} statusTT={statusTT} setStatusPrint={setStatusPrint} statusPrint={statusPrint}/>
                </ScrollView>
            </SafeAreaView>
            {/*---------------Search Modal--------------------*/}
            <Modal
