...
function PaymentRecordScreen({ navigation }) {
    ...
    const searchSoThanhToan = async () => {
        if(createdDate.length > 0 ) {
            setCreateDate(moment(createdDate).format("DD/MM/YYYY"))
        }
        try {
            const response = await apis.apiFilterSoThanhToan(tenSoDoc, createdDate, service, currentPage);
                            ...
                            <Box w="90%" maxW="400">
                                <VStack space="md">
                                    ...
                                    <Box maxW="100%" alignItems="center">
                                        <Input variant="outline" size="md" color="blue.500" onChangeText={handleChange} focusOutlineColor={"blue.600"} value={tenSoDoc} placeholder="Nhập tên sổ" _light={{
                                            bg: "coolGray.100",
                                            _hover: {
                                                bg: "muted.100"
                                            },
                                    ...
                                    >
                                        ...
                                        <Text
                                            style={{
                                                ...
                                                paddingLeft: 15,
                                                alignItems: 'center'
                                            }}>{createdDate?.length > 0 ? moment(createdDate).format("DD/MM/YYYY") : ''}</Text>
                                    </TouchableOpacity>
                                </VStack>
                            </Box>
                        </Box>
