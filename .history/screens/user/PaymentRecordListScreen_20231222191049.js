                        ...
                        <Box alignItems="center" w="100%">
                            <Box w="90%" maxW="400">
                                <VStack space="md">
                                    ...
                                    <Box maxW="100%" alignItems="center">
                                        <Input keyboardType="numeric" variant="outline" size="md" color="blue.500" onChangeText={handleChangeSoDienThoai} focusOutlineColor={"blue.200"} placeholder="Nhập số tiêu thụ" value={inputSDT} _light={{
                                            bg: "coolGray.100",
                                            _hover: {
                                                bg: "muted.100"
                                            },
