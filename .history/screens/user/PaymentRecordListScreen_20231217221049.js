...
import { Center, Skeleton, Modal, Box, VStack, Input, } from 'native-base'
...
function PaymentRecordListScreen({ route, navigation }) {
    ...
    const getHoaDonChuaThanhToanByIdKH = (id) => {
        dispatch(getInvoiceChuaThanhToanByIdKH(id))
        console.log("Hoa don chua TT by ma KH", invoiceChuaTTByMaKH)
    }
                ...
                >
                    ...
                    <TouchableOpacity
                        onPress={() => {
                            ...
                            getHoaDonChuaThanhToanByIdKH('NMCT0000012')
                        }}
                        style={{
                            flexDirection: 'row',
                            alignItems: 'center',
                            ...
                            <Box w="90%" maxW="400">
                                <VStack space="md">
                                    ...
                                    <Box maxW="100%" alignItems="center">
                                        <Input variant="outline" size="md" focusOutlineColor={"white"} placeholder="Nhập tên khách hàng" />
                                    </Box>
                                    <Text style={{
                                        fontFamily: "Quicksand_500Medium"
                                    }}>Trạng thái TT:</Text>
                                    <Box maxW="100%" alignItems="center">
                                        <Input variant="outline" size="md" focusOutlineColor={"blue.200"} placeholder="TT thanh toán" />
                                    </Box>
                                    <Text style={{
                                        fontFamily: "Quicksand_500Medium"
                                    }}>Sản lượng:</Text>
                                    <Box maxW="100%" alignItems="center">
                                        <Input variant="outline" size="md" focusOutlineColor={"blue.200"} placeholder="Nhập sản lượng" />
                                    </Box>
                                    <Text style={{
                                        fontFamily: "Quicksand_500Medium"
                                    }}>Số điện thoại:</Text>
                                    <Box maxW="100%" alignItems="center">
                                        <Input variant="outline" size="md" focusOutlineColor={"blue.200"} placeholder="Nhập số điện thoại" />
                                    </Box>
                                </VStack>
                            </Box>
                        </Box>
