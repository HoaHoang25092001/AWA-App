...
export const apiFilterSoDocChiSo = (thangSoDoc, canBoDocId, tuyenDocId, trangThaiSoDoc, khuVucId, kyGhiChiSoId, nhaMayIds, tenSo, pageNumber) => axios({
    url: `so-doc-chi-so/filter?ThangSoDoc=${thangSoDoc}&CanboDocId=${canBoDocId}&TuyenDocId=${tuyenDocId}&TrangThaiSoDoc=1&KhuVucId=${khuVucId}&KyGhiChiSoId=${kyGhiChiSoId}&NhaMayIds=3059fb9ffdb144c8b6f28806599d4a59&TenSo=${tenSo}&pageNumber=${pageNumber}&pageSize=10`,
    method: 'GET'
})
