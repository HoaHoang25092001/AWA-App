...
export const getInvoiceChuaThanhToanByIdKH = createAsyncThunk("hoa-don/get-all-hoa-don-chua-thanh-toan-by-ma-khach-hang", async (id, { rejectWithValue }) => {
    const response = await apis.apiGetHoaDonChuaThanhToanByMaKhachHang(id)
    console.log(response.data)
