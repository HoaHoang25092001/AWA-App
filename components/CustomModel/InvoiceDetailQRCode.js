...
const InvoiceDetailsModalQRcode = ({
  visible,
  onClose,
  setStatusTT,
  paymentRecordID,
  ...
  const { invoice, statusIF, statusCTT, invoiceChuaTTByMaKH } = useSelector(
    (state) => state.invoice
  );
  const [showConfirmModal, setShowConfirmModal] = useState(false);
  const [successMessage, setSuccessMessage] = useState(null);
  const [selectedPrinter, setSelectedPrinter] = React.useState();
  const { data: dataIdTheDienLuc, loading: loadingIdTheDienLuc } = useSelector(
    (state) => state.hoaDonByIdDienLuc
  );
  // Tìm ngày muộn nhất
  const latestDate = dataIdTheDienLuc?.reduce((latest, item) => {
    return new Date(
      item?.chiSoDongHo.thangTaoSoDoc.split("/")[1],
      item?.chiSoDongHo.thangTaoSoDoc.split("/")[0]
    ) < new Date(latest.split("/")[1], latest.split("/")[0])
      ? item?.chiSoDongHo.thangTaoSoDoc
      : latest;
  }, dataIdTheDienLuc[0]?.chiSoDongHo.thangTaoSoDoc);
  ...
  console.log("Data the dien luc id:", dataIdTheDienLuc);
  ...
  <body>
    <div id="invoice-POS">
      ...
      <div id="mid">
        <div class="info">
          <p> 
            Khách hàng: ${dataIdTheDienLuc.tenKhachHang}</br>
            Mã KH: ${dataIdTheDienLuc.maKhachHang}</br>
            Địa chỉ: ${dataIdTheDienLuc.diaChiKhachHang}</br>
            Điện thoại: ${dataIdTheDienLuc.dienThoaiKhachHang}</br>
            Số hóa đơn: ${dataIdTheDienLuc.soHoaDon}</br>
            Tiêu thụ: ${dataIdTheDienLuc.soTieuThu}</br>
            Chỉ số cũ: ${dataIdTheDienLuc.chiSoCu}</br>
            Chỉ số mới: ${dataIdTheDienLuc.chiSoMoi}</br>
          </p>
        </div>
      </div><!-- End Invoice Mid -->
      ...
      <div id="bot">
        <div id="table">
          <table>
            ...
            ${dataIdTheDienLuc.chiTietHoaDons
              ?.map(
            ...
            <tr class="tabletitle">
              ...
              <td class="itemTotal"><h4>${formatCurrencyVND(
                dataIdTheDienLuc.tongTienTruocVat
              )}</h4></td>
            </tr>
            ...
            <tr class="tabletitle">
              ...
              <td></td>
              <td class="itemTotal"><h4>${formatCurrencyVND(
                dataIdTheDienLuc.tongTienHoaDon
              )}</h4></td>
            </tr>
          </table>
                ...
                <SafeAreaView>
                  <ScrollView showsVerticalScrollIndicator={false}>
                    <IntlProvider locale="vi-VN">
                      {/** Hoa don chua TT */}
                      {dataIdTheDienLuc?.length > 0 ? (
                        loadingIdTheDienLuc === "loading" ? (
                          <SafeAreaView
                          ...
                          dataIdTheDienLuc?.map((data) => (
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  Công ty Cổ phần Xây dựng và CN môi trường Việt
                                  Nam
                                </Text>
                              </View>
                              <View
                              ...
                              >
                                ...
                                {data.chiTietHoaDonRespondModels ? (
                                  data.chiTietHoaDonRespondModels?.map(
                                    (item) => (
                                    ...
                                    "DaThanhToan" ? (
                                      ...
                                      <TouchableOpacity
                                        ...
                                        onPress={() => {
                                          ...
                                          navigator.navigate(
                                            "CustomPrinterUnpaidInvoiceByMDL",
...
export default InvoiceDetailsModalQRcode;
